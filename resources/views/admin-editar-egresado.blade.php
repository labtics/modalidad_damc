...
<marquee>
	<b>Estimado usuario, verifica con el egresado el cambio de su modalidad de titulación antes de guardar los cambios</b>
</marquee>
<br>
<br>
...
@endif
  ...
  <form action="{{ route('modalidad.update',['id' => $user->id]) }}" method="post">  
    @csrf @method('PATCH')            
              <div class="row">
                    <div class="col-md-6">
